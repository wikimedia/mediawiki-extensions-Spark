 ...
 */
$messages['ast'] = array(
	'spark-desc' => "Amiesta la etiqueta <code><nowiki><spark /></nowiki></code> que permite incrustar entemezos ''(mash-ups)'' de [http://km.aifb.kit.edu/sites/spark/ Spark]. La biblioteca spark ye una creación de Denny Vrandecic y Andreas Harth.",
	'spark-missing-query' => "Fai falta qu'especifiques una consulta usando'l parámetru «data-spark-query».",
);
 ...
 */
$messages['dsb'] = array(
	'spark-desc' => 'Pśidawa toflicku <code><nowiki><spark /></nowiki></code>, kótaraž zmóžnja zasajźenje [http://km.aifb.kit.edu/sites/spark/ Sparkowych] mashupow. Biblioteka Spark jo se wót Dennisa Vrandecic a Andreasa Hartha napórała.',
 ...
 */
$messages['es'] = array(
	'spark-desc' => "Añade una etiqueta <code><nowiki><spark /></nowiki></code> que permite incrustar ''mash-ups'' de [http://km.aifb.kit.edu/sites/spark/ Spark]. La biblioteca spark fue creada por Denny Vrandecic y Andreas Harth.",
...
$messages['ja'] = array(
	...
	'spark-missing-query' => '「data-spark-query」パラメーターを使用してクエリを指定する必要があります。',
);
